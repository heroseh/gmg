...
int main(int argc, char** argv) {
...

	{
...

		{
			...
			gmg_assert_result(gmg_material_set_texture(app.logical_device, app.material_id, 1, 0, texture_id));
		}
...

	{
		...
		gmg_assert_result(gmg_material_set_sampler(app.logical_device, app.material_id, 0, 0, sampler_id));
	}
